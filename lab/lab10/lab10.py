...
def subseqs(s):
    ...
    if len(s) == 1:
        ...
        itm = s.pop(0)
        list1 = subseqs(s)
        return insert_into_all(itm, list1) + list1
...
def trade(first, second):
    ...
    equal_prefix = lambda list1, list2: sum(list1) == sum(list2)
        ...
        if layer % 2 == 0:
            ...
            if a % 2 == 0:
                for i in range(int(a / 2)):
                    t.branches[i].label, t.branches[a-i-1].label = t.branches[a-i-1].label, t.branches[i].label
            else:
                for i in range(int((a-1) / 2)):
                    t.branches[i].label, t.branches[a-i-1].label = t.branches[a-i-1].label, t.branches[i].label 
        for branch in t.branches:
            reverse_helper(branch, layer+1)
    reverse_helper(t, 0)
